    ...
    <>
      <div className="w-full container mx-auto mb-20">
        ...
        <div className="grid gap-3 w-full break-words lg:pt-28 max-sm:pt-20 grid-cols-1 lg:grid-cols-2 lg:min-h-[600px]">
          <div className="flex flex-col text-xl lg:text-4xl col-span-1 lg:pl-28 gap-10">
            <div className="col-span-1 relative aspect-square lg:hidden">
              <Image
                src={"/work/vermietet/VermietetSideImg.jpg"}
                layout="fill"
            ...
            <div className="flex flex-col gap-3 max-sm:ms-5">
              <Image
                src={"/work/vermietet/VermietetLogo.png"}
                width={300}
                height={300}
                alt="wwtf"
              />
        ...
        <div className="relative h-auto w-full  lg:w-[90%] max-sm:w-[90%] lg:mx-auto max-sm:mx-auto lg:mt-28 max-sm:mt-24 px-4 lg:px-0 ">
          <Image
            src={"/work/vermietet/PREISE_Desktop.jpg"}
            width={0}
            height={0}
            layout="responsive"
            alt=""
        ...
        <ImageTextOverlay
          OverlayImageSrc="/work/vermietet/vermietetImage.jpg"
          OverlayText="Lorem ipsum dolor sit."
        />

        {/* HeroImgText Section*/}
        <HeroImgText
          HeroimageSrc="/work/vermietet/vermietetMan.jpg"
          content={[
        ...
        <div className="relative w-full aspect-square lg:aspect-video mt-28 h-fit flex justify-center place-items-center object-cover bg-cover">
          <Image
            src={"/work/vermietet/vermietetPlaceholder.jpeg"}
            layout="fill"
            alt=""
            className="-z-30"
          />
        ...
        <Content
          ...
          imageSrc="/work/vermietet/VermietetRightImg.jpg"
        />

        {/* Banner Section */}
        <Banner BannerImageSrc="/work/vermietet/VermietetFrame.png" />
        ...
        <div className="flex justify-between max-sm:justify-center mt-28 max-sm:mt-[340px] place-items-end h-[1050px]">
          <div className="grid lg:grid-cols-3 lg:gap-32 max-sm:gap-20">
            <div>
              <IphoneFrame src="/work/vermietet/HOME_Mobile.png" />
            </div>
            <div className="relative lg:translate-y-[-60px]">
              <IphoneFrame
                src="/work/vermietet/BLOG_ARTIKELSEIT.png"
                className="place-self-start"
              />
            </div>
            <div className="lg:block max-sm:hidden">
              <IphoneFrame src="/work/vermietet/PREISE_Mobile.png" />
            </div>
          </div>
        </div>
        ...
        <ImagesSection
          imageSources={[
            "/work/vermietet/Left.png",
            "/work/vermietet/Right.jpg",
          ]}
        />
        {/* Desktop Image */}
        <div className="relative h-auto w-full  lg:w-[90%] max-sm:w-[90%] lg:mx-auto max-sm:mx-auto lg:mt-28 max-sm:mt-24 px-4 lg:px-0 ">
          <Image
            src={"/work/vermietet/HOMEPAGE_ABOUT US.jpg"}
            width={0}
            height={0}
            layout="responsive"
            alt=""
        ...
        {/* Overlay Image With Text */}
        <ImageTextOverlay
          OverlayImageSrc="/work/vermietet/Overlay2.jpg"
          OverlayText="Lorem ipsum dolor sit."
        />
        {/* Footer Heading  */}
