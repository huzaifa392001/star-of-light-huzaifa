...
export default function Index() {
  return (
    <>
      <Head>
        <title>Everphone - Philippe Layani</title>
        <meta name="description" content="Generated by create next app" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <Wrapper>
        <InnerHero heading={["Everphone"]} />
        <SubHeading
          subHeading={
            "Welcome to Everphone, the ultimate destination for anyone looking for stunning and high-quality Bauhaus wallpaper. The website has been designed to provide a seamless and enjoyable shopping experience."
          }
        />
        <ContentSection
