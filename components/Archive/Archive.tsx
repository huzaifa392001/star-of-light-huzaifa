...
const Archive = () => {
    ...
    () => {
      ...
      mm.add(
        ...
        (context) => {
          ...
          if (isDesktop) { // Run only on desktop
            let cards = document.querySelectorAll('[class*="archive_archiveCard_"]');
            let values = ['-80', "-40", "-80", "-20", "-60", "-20", "-60", "-40", "-20", "-60", "-60", "-100", "-40", "-70", "-70", "-70", "-150"];
  ...
  return (
    <section id="archive" ref={container} className={s.main}>
      {/* <Elements /> */}
      <svg className={`archive ${s.svgElement}`} ref={elementAnimation} width="1920" height="1080" viewBox="0 0 1920 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
